...
(library Library_1
	...
	(compDef "LM386M-1_NOPB" (originalName "LM386M-1_NOPB") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "GAIN_1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "8" (pinName "GAIN_2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "BYPASS") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://docs-emea.rs-online.com/webdocs/06e8/0900766b806e88be.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "LM386M-1_NOPB.stp")
