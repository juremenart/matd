...
(library Library_1
	...
	(patternDef "SOIC127P602X168-9N" (originalName "SOIC127P602X168-9N")
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.95 1.175) (pt -0.68 2.445) (width 0.1))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "MIC4127YME" (originalName "MIC4127YME") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		...
		(compPin "8" (pinName "NC_2") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "OUTA") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "VS") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "OUTB") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://ww1.microchip.com/downloads/en/DeviceDoc/MIC4126-27-28-Data-Sheet-20006084A.pdf")
		(attr "Height" "1.68 mm")
	)
