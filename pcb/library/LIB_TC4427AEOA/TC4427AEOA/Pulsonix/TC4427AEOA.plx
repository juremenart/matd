...
(library Library_1
	...
	(compDef "TC4427AEOA" (originalName "TC4427AEOA") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "4" (pinName "IN B") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "8" (pinName "NC_2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "OUT A") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "VDD") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "OUT B") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/2/TC4427AEOA.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "TC4427AEOA.stp")
